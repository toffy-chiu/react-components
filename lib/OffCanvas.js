...
var OffCanvas=React.createClass({
    ...
    handleShown:function(){
        //为退场动画做准备
        var $offCanvas=$(this.refs.offCanvas).addClass('am-active');
        setTimeout(function(){
            $offCanvas.find('.am-offcanvas-bar').addClass('am-offcanvas-bar-active');
        }, 0);
    ...
    handleClose:function(){
        //开始退场动画
        $(this.refs.offCanvas).find('.am-offcanvas-bar').removeClass('am-offcanvas-bar-active');
